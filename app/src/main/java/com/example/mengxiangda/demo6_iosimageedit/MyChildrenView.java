...
public class MyChildrenView extends View {
    ...
    public MyChildrenView(Context context) {
        this(context, null);
    }

    public MyChildrenView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyChildrenView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private boolean isUnderOperation = false;

    public boolean isUnderOperation() {
        return isUnderOperation;
    }
